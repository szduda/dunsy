...
export const BellnardNail: FC = () => {
  ...
  const slides = {
    "": <>Ohhhh hello John! Sorry, I didn&rsquo;t hear you come in.</>,
    intro: (
                  ...
                  setTimeout(() => {
                    timeouts.push(
                      setTimeout(() => {
                        setVisibility("shadow");
                        timeouts.push(
                          setTimeout(() => setSlide("nextDay"), 2000)
                        );
                      }, 2000)
                    );
                  })
    ...
    lead: (
      <>
        ...
        <span className={cx(["tracking-widest"])}>&nbsp;luck</span>.
      </>
    ),
    follow: (
      <>
    ...
    <div
      className={cx([
        ...
        visibility === "visible"
          ...
          : "absolute bottom-[calc(100%-178px)] md:bottom-[calc(100%-182px)] translate-x-[72px] scale-50",
      ])}
    ...
    >
      ...
      <BellnardNailIcon
        onClick={() => {
          ...
          if (slide === "") {
            timeouts.push(setTimeout(() => setSlide("intro"), 3000));
