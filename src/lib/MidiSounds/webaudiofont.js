...
var WebAudioFontChannel = /** @class */ (function () {
  function WebAudioFontChannel(audioContext) {
    ...
    this.band = this.bandEqualizer(this.input, 0);
    this.output = audioContext.createGain();
    this.band.connect(this.output);
  }
...
var WebAudioFontLoader = /** @class */ (function () {
  ...
  WebAudioFontLoader.prototype.startLoad = function (
    audioContext,
    filePath,
    variableName
  ) {
  ...
  WebAudioFontLoader.prototype.decodeAfterLoading = function (
    audioContext,
    variableName
  ) {
    var me = this;
  ...
  WebAudioFontLoader.prototype.waitOrFinish = function (
    variableName,
    onFinish
  ) {
    if (window[variableName]) {
...
var WebAudioFontPlayer = /** @class */ (function () {
  ...
  WebAudioFontPlayer.prototype.setupEnvelope = function (
    audioContext,
    envelope,
    zone,
    volume,
  ...
  WebAudioFontPlayer.prototype.findZone = function (
    audioContext,
    preset,
    pitch
  ) {
