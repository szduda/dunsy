...
#### Instrument Sound
- define sound asset and symbol in `DRUMS` array in `MidiSounds/config.ts`
- update `font` in `GroovyPlayer/canvas/drumFont.ts`
- add new symbol to `vocabulary` regex in `SnippetApi/validate.ts`
